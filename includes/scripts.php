...
function edd_plugin_name_admin_scripts( $hook ) {
    ...
    if( $hook == $edd_settings_page ) {
        wp_enqueue_script( 'edd_plugin_name_admin_js', RAZORPAY_FOR_EDD_URL . '/assets/js/admin' . $suffix . '.js', array( 'jquery' ) );
        wp_enqueue_style( 'edd_plugin_name_admin_css', RAZORPAY_FOR_EDD_URL . '/assets/css/admin' . $suffix . '.css' );
    }
}
...
function edd_plugin_name_scripts( $hook ) {
    ...
    wp_enqueue_script( 'edd_plugin_name_js', RAZORPAY_FOR_EDD_URL . '/assets/js/scripts' . $suffix . '.js', array( 'jquery' ) );
    wp_enqueue_style( 'edd_plugin_name_css', RAZORPAY_FOR_EDD_URL . '/assets/css/styles' . $suffix . '.css' );
}
